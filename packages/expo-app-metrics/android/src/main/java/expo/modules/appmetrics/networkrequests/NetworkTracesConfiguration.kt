...
data class NetworkTracesConfiguration(
  ...
  /** Built once per policy rather than per request; the fields never change after decoding. */
  private val filter = NetworkRequestFilter(hosts = hosts, methods = methods)
